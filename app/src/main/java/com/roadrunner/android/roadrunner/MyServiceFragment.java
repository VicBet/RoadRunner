...
public class MyServiceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_myservice, container, false);

        getActivity().setTitle("Servicing");

        txtNoNotifications = (TextView) mView.findViewById(R.id.txtService);

        mFloat = (FloatingActionButton) mView.findViewById(R.id.floatingActionButtonSV);

        mNotificationList = (RecyclerView) mView.findViewById(R.id.blog_list_myservice);
        ...
        mFloat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.fragment_container, new GarageFragment());
                transaction.commit();
            }
        });
        ...
        mFriendsReqDatabase  = FirebaseDatabase.getInstance().getReference().child("Users").child(mCurrent_user_id).child("service");
            ...
            protected void populateViewHolder(final NotificationsViewHolder viewHolder, Notifications model, int position) {
                ...
                mFriendsReqDatabase.child(post_key).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String userName = (String) dataSnapshot.child("service").getValue();
                        String userProf = (String) dataSnapshot.child("profimage").getValue();
                        String model = (String) dataSnapshot.child("location").getValue();
    ...
    public static class NotificationsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setProfimage() {
                ...
                Picasso.get().load(R.drawable.wrench).networkPolicy(NetworkPolicy.OFFLINE)
                    ...
                    public void onError(Exception e) {
                        ...
                        Picasso.get().load(R.drawable.wrench).placeholder(R.drawable.userprof2).into(friends_profimage);
