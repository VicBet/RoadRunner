...
public class RefuelFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_refuel, container, false);


        getActivity().setTitle("Refueling");

        txtNoNotifications = (TextView) mView.findViewById(R.id.txtRefuel);

        mFloat = (FloatingActionButton) mView.findViewById(R.id.floatingActionButtonRF);

        mNotificationList = (RecyclerView) mView.findViewById(R.id.blog_list_refuel);
        ...
        mFloat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.fragment_container, new GasFragment());
                transaction.commit();
            }
        });
        ...
        mFriendsReqDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(mCurrent_user_id).child("fuelExpense");
            ...
            protected void populateViewHolder(final NotificationsViewHolder viewHolder, Notifications model, int position) {
                ...
                mFriendsReqDatabase.child(post_key).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String userName = (String) dataSnapshot.child("fuel").getValue();
                        String userProf = (String) dataSnapshot.child("profimage").getValue();
                        String model = (String) dataSnapshot.child("station").getValue();
    ...
    public static class NotificationsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setProfimage() {
                ...
                Picasso.get().load(R.drawable.oil2).networkPolicy(NetworkPolicy.OFFLINE)
                    ...
                    public void onError(Exception e) {
                        ...
                        Picasso.get().load(R.drawable.oil2).placeholder(R.drawable.userprof2).into(friends_profimage);
